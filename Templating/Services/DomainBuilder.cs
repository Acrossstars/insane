...
//            userCasesBuilder.GenerateUseCase(_domainEntity, _metadataDir);
//        }
//    }
...
public class DomainBuilder
{
    ...
    public void BuildEntities()
    {
        ...
        var outputFilePath = _pathService.CreateEntityPath(_manyEntities);
        ...
        foreach (var metadata in _domainDefinition.Entities!)
        {
            ...
            metadata.Namespace = _namespaceService.CreateEntityNamespace(_manyEntities);
    ...
    public void BuildEvents()
    {
        ...
        foreach (var domainEvent in _domainDefinition.Events!)
        {
            var metadata = new DomainEventMetadata
            {
                ...
                FilePath = "",
                Usings = Array.Empty<string>(),
                Namespace = _namespaceService.CreateEventsNamespace(_manyEntities),
